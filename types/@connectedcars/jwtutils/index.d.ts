...
export function JwtAuthMiddleware(pubKeys: any, revokedKeys: string[], audiences: string[], mapper: (user: any) => void, options?: JwtAuthMiddlewareOptions): (request: any, response: any, next: () => void) => void
